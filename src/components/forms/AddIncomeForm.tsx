...
export function AddIncomeForm({ onSubmit, onClose }: AddIncomeFormProps) {
  ...
  // Auto-set expected for one-time items
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center" role="dialog" aria-modal="true" onKeyDown={(e) => e.key === "Escape" && onClose()}>
      ...
      <div className="relative z-10 w-full max-w-lg rounded-t-xl bg-white shadow-xl sm:rounded-xl">
        ...
        <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4">
          <h2 className="text-[16px] font-bold text-gray-900">Add Income</h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4 px-5 py-5">
            {/* Name */}
            <div>
              <label className="text-[12px] font-semibold text-gray-500">Source Name</label>
              <input
                type="text"
                value={name}
