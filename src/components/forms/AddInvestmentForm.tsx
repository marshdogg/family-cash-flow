...
export function AddInvestmentForm({ onSubmit, onClose, initialData }: AddInvestmentFormProps) {
  ...
  return (
    <div ref={trapRef} className="fixed inset-0 z-[60] flex items-end justify-center px-3 sm:items-center sm:px-4" role="dialog" aria-modal="true" aria-labelledby="invest-dialog-title" onKeyDown={(e) => e.key === "Escape" && onClose()}>
