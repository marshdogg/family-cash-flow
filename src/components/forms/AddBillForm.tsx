      ...
      <div className="relative z-10 w-full max-w-lg rounded-t-xl bg-white shadow-xl sm:rounded-xl">
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4 px-5 py-5">
            {/* Name */}
            <div>
              <label htmlFor="bill-name" className="text-[12px] font-semibold text-gray-500">Name</label>
              <input
                id="bill-name"
                type="text"
                value={name}
              ...
              />
              {errors.name && <p id="bill-name-error" className="mt-1 text-[11px] text-red-500">{errors.name}</p>}
            </div>
            ...
            {/* Next Due Date */}
            <div>
              <label htmlFor="bill-date" className="text-[12px] font-semibold text-gray-500">Next Due Date</label>
              <input
                id="bill-date"
                type="date"
                value={nextDate}
